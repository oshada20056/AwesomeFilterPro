...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('🔋 Hᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔋', url='https://t.me/filmstudodl')
        ]
    )
    btn.insert(1, 
        [
            InlineKeyboardButton('Web Site', url='https://filmxyz.studio'),
            InlineKeyboardButton('Group', url='https://t.me/filmstudodl')
        ]
    )
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('𝖥𝗂𝗅𝗆𝖷𝗒𝗓 :)')
            else:
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('🔋 Hᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔋', url='https://t.me')
        ]
    )
    if offset != "":
